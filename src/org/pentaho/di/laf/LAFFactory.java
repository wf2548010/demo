...
/**wf**///import org.pentaho.di.i18n.MessageHandler;

/**
 * the LAFFactory provides a mechanism(机制) whereby（通过） @see Handler s can be dynamically replaced to enable user driven
...
public class LAFFactory {
  ...
  /**wf**///static Class<? extends Handler> _defMessageHandler = org.pentaho.di.i18n.LAFMessageHandler.class;
  ...
  static {
    ...
    /**wf**///handlerRef.put( MessageHandler.class.getName(), _defMessageHandler );
