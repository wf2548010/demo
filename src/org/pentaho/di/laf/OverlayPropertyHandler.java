...
/**wangfei**///import org.pentaho.di.core.Const;
...
public class OverlayPropertyHandler implements PropertyHandler {
  ...
  protected boolean loadAltProps() {
    ...
    /**wangfei**///String altFile = Const.getEnvironmentVariable( "org.pentaho.di.laf.alt", null );
    /**wangfei**///if ( altFile != null ) {
    /**wangfei**///  return loadProps( altFile );
    /**wangfei**///}
    return false;
  }
